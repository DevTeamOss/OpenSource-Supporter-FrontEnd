...
describe('Repo Detail View Model Test', () => {
    function createTestHook() {
        return renderHook(() => useRepoDetail(), {
            wrapper: ReduxProvider,
        })
    }

    test('뷰모델은 선언 시 초기값으로 id는 null, data는 빈 객체를 갖는다', () => {
    ...
    test('레포를 선택하면 뷰모델은 id 값으로 선택한 레포의 id 값을 갖는다', () => {
